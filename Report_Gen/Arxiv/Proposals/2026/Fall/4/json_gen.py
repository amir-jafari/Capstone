...
data_to_save = \
    {
        ...
        # -----------------------------------------------------------------------------------------------------------------------
        "project_name":
            """SynthAug-Bench: When Does Diffusion-Based Synthetic Data Augmentation Help Computer Vision Classifiers? A Benchmark Across Generator Fidelity, Data-Scarcity Regimes, and CNN/Transformer Architectures""",
        # -----------------------------------------------------------------------------------------------------------------------
        "Objective":
            """
        ...
        "Research Contributions":
            ...
            - The first benchmark spanning the full generator-fidelity spectrum -- classical augmentation,
              GAN, from-scratch diffusion, training-free pretrained diffusion, and parameter-efficient-
              fine-tuned pretrained diffusion -- evaluated under one protocol across four data-scarcity
              regimes and two classifier architecture families (CNN, Transformer)
            - A direct test of whether downstream accuracy gain from synthetic augmentation grows
              monotonically with generator fidelity, plateaus, or reverses (H1)
            - A documented domain-gap finding comparing training-free vs. fine-tuned diffusion augmentation
              on real-world imbalanced medical imaging (HAM10000)

            2. METHODOLOGICAL CONTRIBUTIONS:
            - A quantitative test of whether FID and Improved Precision/Recall predict downstream training
              utility (H3), directly answering an open question raised in prior synthetic-augmentation
              papers about whether generative-quality metrics can substitute for a full retraining sweep
            - Extension of the DA-Fusion training-free augmentation protocol (Trabucco et al., 2023) to
              new fine-grained and medical datasets/classifiers not covered in the original paper
            - A standardized synthetic-augmentation benchmarking protocol (fixed multi-seed evaluation,
              synthetic:real ratio sweep, matched compute budget per condition) reusable by future studies

            3. LIBRARY CONTRIBUTIONS:
            - SynthAug-Bench: an open-source, config-driven repository implementing all five generator
              conditions behind a common data/classifier/evaluation interface
            - Reference implementations of StyleGAN2-ADA, from-scratch class-conditional DDPM, DA-Fusion-
              style training-free augmentation, and LoRA/DreamBooth fine-tuning, all validated to run within
              a single AWS g5.2xlarge instance's compute budget

            PUBLICATION VENUES:
            - CVPR / ICCV / ECCV workshops on Synthetic Data for Computer Vision, Data-Centric AI, or
            ...
            - 1 GitHub repository (SynthAug-Bench) with automated benchmarking script and reproducible
              notebooks
            - A practical, citable guideline table for choosing a synthetic-augmentation strategy under a
        ...
        "Additional Resources":
            ...
            - HuggingFace diffusers: https://github.com/huggingface/diffusers
              Stable Diffusion pipelines, DreamBooth/LoRA/textual-inversion training scripts, SD-Turbo/LCM
              few-step schedulers
            - HuggingFace peft (LoRA): https://github.com/huggingface/peft
            - StyleGAN2-ADA (NVIDIA official): https://github.com/NVlabs/stylegan2-ada-pytorch
            - timm (classifier backbones): https://github.com/huggingface/pytorch-image-models
            - clean-fid: https://github.com/GaParmar/clean-fid
            - DA-Fusion (official reference implementation): https://github.com/brandontrabucco/da-fusion

            KEY REFERENCE PAPERS:
            1. Ho, J., Jain, A., Abbeel, P. (2020). "Denoising Diffusion Probabilistic Models." NeurIPS.
               (DDPM)
            2. Rombach, R., Blattmann, A., Lorenz, D., Esser, P., Ommer, B. (2022). "High-Resolution Image
               Synthesis with Latent Diffusion Models." CVPR. (Stable Diffusion)
            3. Song, J., Meng, C., Ermon, S. (2020). "Denoising Diffusion Implicit Models." arXiv:2010.02502.
               (DDIM fast sampling)
            4. Karras, T. et al. (2020). "Training Generative Adversarial Networks with Limited Data."
               NeurIPS. (StyleGAN2-ADA)
            5. Ruiz, N. et al. (2023). "DreamBooth: Fine Tuning Text-to-Image Diffusion Models for
               Subject-Driven Generation." CVPR.
            6. Gal, R. et al. (2022). "An Image is Worth One Word: Personalizing Text-to-Image Generation
               using Textual Inversion." arXiv:2208.01618.
            7. Hu, E.J. et al. (2021). "LoRA: Low-Rank Adaptation of Large Language Models."
               arXiv:2106.09685.
            8. Trabucco, B., Doherty, K., Gnanasambandam, A., Salakhutdinov, R. (2023). "Effective Data
               Augmentation With Diffusion Models." arXiv:2302.07944. (DA-Fusion)
            9. Azizi, S. et al. (2023). "Synthetic Data from Diffusion Models Improves ImageNet
               Classification." arXiv:2304.08466.
            10. He, R. et al. (2023). "Is synthetic data from generative models ready for image
                recognition?" ICLR.
            11. Sariyildiz, M.B. et al. (2023). "Fake it till you make it: Learning transferable
                representations from synthetic ImageNet clones." CVPR.
            12. Dunlap, L. et al. (2023). "Diversify Your Vision Datasets with Automatic Diffusion-Based
                Augmentation." NeurIPS. (ALIA)
            13. Heusel, M. et al. (2017). "GANs Trained by a Two Time-Scale Update Rule Converge to a
                Local Nash Equilibrium." NeurIPS. (FID)
            14. Kynkaanniemi, T., Karras, T., Laine, S., Lehtinen, J., Aila, T. (2019). "Improved Precision
                and Recall Metric for Assessing Generative Models." NeurIPS.
            15. Parmar, G., Zhang, R., Zhu, J.-Y. (2022). "On Aliased Resizing and Surprising Subtleties in
                GAN Evaluation." CVPR. (clean-fid)
            16. Cui, Y., Jia, M., Lin, T.-Y., Song, Y., Belongie, S. (2019). "Class-Balanced Loss Based on
                Effective Number of Samples." CVPR. (CIFAR-LT protocol)
            17. Zhang, H. et al. (2018). "mixup: Beyond Empirical Risk Minimization." ICLR.
            18. Yun, S. et al. (2019). "CutMix: Regularization Strategy to Train Strong Classifiers with
                Localizable Features." ICCV.
            19. Cubuk, E.D. et al. (2019). "RandAugment: Practical automated data augmentation with a
                reduced search space." arXiv:1909.13719.
            20. Tschandl, P., Rosendahl, C., Kittler, H. (2018). "The HAM10000 dataset, a large collection
            ...
            - AWS g5.2xlarge (1x NVIDIA A10G, 24 GB VRAM, 8 vCPUs, 32 GiB RAM) as the target compute
              environment; bf16 mixed precision is natively supported on the A10G's Ampere architecture
            - SD-Turbo / LCM-LoRA few-step samplers to keep synthetic-image generation wall-clock low at
              inference time
            """,
        # -----------------------------------------------------------------------------------------------------------------------
